...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "BitcoinWalletApp.Android.dll" comes first in this list. */
		"BitcoinWalletApp.Android.dll",
		"Transactions.dll",
		"QRCodeKey.dll",
		"BitcoinWalletApp.dll",
		...
		"FormsViewGroup.dll",
		"Google.Protobuf.dll",
		"Info.Blockchain.API.Standart.dll",
		"Ipfs.Core.dll",
